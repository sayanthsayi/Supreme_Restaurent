    ...
    <div className='max-w-[1640px] mx-auto gap-8 p-4 py-12 grid md:grid-cols-3 gap-6x'>
        ...
        <div className='rounded-xl relative '>
            ...
            <div className='absolute w-full h-full bg-black/50 rounded-xl text-white px-4'>
                <p className='font-bold text-2xl px-2 pt-[25px]'>Sun's Out, BOGO's Out</p>
        ...
        <div className='rounded-xl relative'>
            {/* overlay */}
            <div className='absolute w-full h-full bg-black/50 rounded-xl text-white px-4'>
                <p className='font-bold text-2xl px-2 pt-[25px]'>New Restaurents</p>
        ...
        <div className='rounded-xl relative'>
            {/* overlay */}
            <div className='absolute w-full h-full bg-black/50 rounded-xl text-white px-4'>
                <p className='font-bold text-2xl px-2 pt-[25px]'>We deliver Deserts</p>
